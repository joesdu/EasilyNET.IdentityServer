...
import {
  ProLayout,
} from "G:/EasilyNET.IdentityServer/src/EasilyNET.IdentityServer.Admin/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const formatMessage = undefined;
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'easilynet-identityserver-admin'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
